...
const chatMessages = [
  {
    from: "user",
    text: "Hi! I'd like to learn more about K12 AR Pedia for our primary school. We have about 200 students.",
    time: "10:32 AM",
  },
  {
    from: "team",
    text: "Hello! Great to hear from you 😊 We'd love to set up a free demo at your school. Which state are you located in?",
    time: "10:33 AM",
    read: true,
  },
  {
  ...
  {
    from: "team",
    text: "Perfect — we have active coordinators in Lagos. I can arrange a full school demo within 48 hours. Let me connect you now ✅",
    time: "10:34 AM",
    read: true,
  },
];
...
export default function WhatsAppSection() {
  return (
    <section className="relative bg-white py-16 sm:py-20 lg:py-24 overflow-hidden">
      {/* Background green radial tint */}
      <div
        className="absolute inset-0 pointer-events-none"
        style={{
          background:
            "radial-gradient(ellipse at 50% 100%, rgba(37,211,102,0.07) 0%, transparent 65%)",
        }}
      />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          >
            <div className="space-y-4">
              ...
              >
                Need Help? Chat With Our Deployment Team
              </h2>
              <p
                className="text-gray-600 text-base sm:text-lg leading-relaxed"
                style={{ fontFamily: "var(--font-jarkata)" }}
              >
                Talk directly with experts who can guide you from first question
                to full school deployment — all on WhatsApp.
              </p>
            </div>
            ...
            <div className="flex flex-wrap gap-2">
              {teamTypes.map((type) => (
                <span
                  key={type}
                  className="px-3.5 py-1.5 bg-gray-50 border border-gray-200 text-gray-700 rounded-full text-sm font-medium"
                >
                  {type}
                </span>
              ))}
            ...
            <div className="flex flex-col gap-3">
              <a
                ...
                className="inline-flex items-center justify-center gap-3 px-8 py-4 bg-[#25D366] text-white font-bold rounded-2xl shadow-lg hover:bg-[#1fb558] hover:shadow-xl transition-all duration-300 text-base sm:text-lg w-full sm:w-auto"
              >
          ...
          >
            ...
            <div className="relative w-72 sm:w-80">
              <div className="bg-gray-900 rounded-[2.5rem] p-3 shadow-2xl border-10 border-gray-800">
                {/* Notch */}
                ...
                <div className="rounded-[1.75rem] overflow-hidden" style={{ background: "#E5DDD5" }}>
                  ...
                  <div className="px-3 py-4 space-y-3 min-h-[280px]">
                    ...
                    <div className="flex justify-center">
                      <span className="bg-white/60 text-gray-500 text-[9px] px-2.5 py-0.5 rounded-full">
                        Today
                      </span>
                    </div>
